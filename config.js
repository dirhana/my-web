...
window.EZ_CONFIG = {
  ...
  // 中间件服务器URL (不含路径)
  API_MIDDLEWARE_URL: 'https://1322253634-2zobdsgxkg.ap-chengdu.tencentscf.com',
  
  // 中间件路由前缀 (与中间件服务器配置保持一致)
  API_MIDDLEWARE_PATH: '/WebApi',
  ...
  SITE_CONFIG: {
    siteName: '樱花云',
    siteDescription: 'SakuraCloud UI',
    // copyright会自动使用当前年份
    copyright: `© ${new Date().getFullYear()} SakuraCloud THEME. All Rights Reserved.`,
  ...
  AUTH_CONFIG: {
    ...
    popup: {
      ...
      // 弹窗内容 (支持HTML)
      content: "<p><strong>欢迎使用我们的服务！</strong></p><p>请注意以下事项：</p><ul><li>请妥善保管您的账号信息</li><li>如有问题请发送工单和联系客服</li></ul>",
  ...
  SHOP_CONFIG: {
    ...
    popup: {
      ...
      // 弹窗内容 (支持HTML)
      content: "<p><strong>周期性套餐默认每月订单日重置流量，您当月未用使用完的流量，不会累积到下个月</strong></p><p>🔥热门地区：香港、狮城、日本、台湾、韩国、美国、印度、英国、德国、荷兰、加拿大、意大利、澳大利亚</p><p>🧊冷门地区：马来西亚、越南、缅甸、印尼、澳门、泰国、迪拜、埃及、南极洲、柬埔寨、菲律宾、卡塔尔、阿根廷、俄罗斯、乌克兰、土耳其、巴基斯坦、尼日利亚、摩尔多瓦等</p>",
  ...
  WALLET_CONFIG: {
    // 预设充值金额选项（单位：元）
    presetAmounts: [10, 30, 50, 100, 200, 500, 888, 999],
  ...
  INVITE_CONFIG: {
    ...
    inviteLinkConfig: {
      ...
      customDomain: 'https://www.yhyaff.com'
    }
  },
  ...
  CUSTOMER_SERVICE_CONFIG: {
    ...
    customHtml: '<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="5d7be2dc-fec3-44a5-a1e9-87919e6d48d6";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>',
